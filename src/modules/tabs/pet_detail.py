...
class PetDetailOverlay(ft.Container):
    def __init__(self, page: ft.Page):
        ...
        self.content = ft.Column(
            controls=[
                ...
                ft.Button(content=ft.Text("Добавить заметку"), color=ft.Colors.BLUE_900, on_click=self.notes_button_clicked),
            ],
            spacing=12,
        )
    ...
    def show_pet(self, pet: Pet):
        ...
        self._detail_content.controls = [
            ...
            ft.Text(str(pet.birthday)[0:10], size=16, color=ft.Colors.GREY_400),
            ft.Text(
